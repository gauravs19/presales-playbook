...
*Action:*
*   Turn on "Do Not Disturb" (Mac) or "Focus Assist" (Windows) to block all OS-level notifications.
*   Quit Slack, Microsoft Teams, and WhatsApp Desktop entirely. (Closing the window is not enough; quit the background processes). You do not want a colleague messaging you "This prospect seems cheap" while you are screen-sharing.
*   Hide your desktop icons. (A messy desktop with 400 loose files induces anxiety in the viewer).
