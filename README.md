<div id="playbook-hero" style="position: relative; background: linear-gradient(135deg, #1e3a8a 0%, #0f172a 100%); color: white; padding: 5rem 2rem; border-radius: 12px; margin-bottom: 2.5rem; text-align: center; box-shadow: 0 10px 30px rgba(0,0,0,0.15); overflow: hidden;">
    ...
    <div style="position: relative; z-index: 2;">
        ...
        <p style="font-size: 1.25rem; opacity: 0.9; margin-top: 1.25rem; max-width: 800px; margin-left: auto; margin-right: auto; line-height: 1.6;">The practitioner-built field guide to orchestrating complex enterprise deals — bridging the gap between technical architecture and commercial value.</p>
    </div>
</div>
